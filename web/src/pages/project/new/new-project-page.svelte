<script lang="ts">
  import ProjectDescription from "~/components/project/description.svelte";
  import ProjectTitle from "~/components/project/title.svelte";
  import RoleEditor from "~/components/role-editor.svelte";
  import { ProjectCreator } from "~/controllers/project-creator.svelte";

  const ctl = new ProjectCreator();
</script>
...
<div>
  ...
  >
    <div class="hm-blocks-container">
      ...
      <RoleEditor controller={ctl.roles} onsave={null} />
