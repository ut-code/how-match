...
<header class="sticky top-0 left-0 w-full z-30 px-6 pt-6 flex-row">
  <div
    class="h-14 px-6 gap-8 flex items-center align-middle rounded-xl bg-white/60 dark:bg-gray-500/60 backdrop-blur-md border border-gray-200 dark:border-gray-400"
  >
